        ...
        @foreach ($clubs as $club)
            <span>
                <span class="list__item">
                    <img src="{{ asset('assets/img/default-logo.png') }}" alt="Club Background" class="item__background">
                    <div class="item__left">
                        <img src="{{ asset('assets/img/default-logo.png') }}" alt="Club Logo" class="item__logo">
